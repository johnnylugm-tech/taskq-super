...
| FR → SPEC.md citation | 100% (10/10) | 10/10 | PASS |
| NFR → SPEC.md citation | 100% (12/12) | 12/12 | PASS |
| Source path = bare `SPEC.md` (root) | 100% (22/22) | 22/22 | PASS |
| Total FR + NFR coverage | 22/22 | 22/22 | PASS |
